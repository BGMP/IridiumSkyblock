...
public class Messages {
    ...
    public String cantFly = "%prefix% &7You may not fly in this Island.";
    public String cantBan = "%prefix% &7You may not ban players in this Island.";
    public String cantEnderpearl = "%prefix% &7You may not use Enderpearls in this Island.";
    public String cantMilk = "%prefix% &7You may not milk cows in this Island.";
    public String cantShear = "%prefix% &7You may not shear sheeps in this Island";
    public String cantUseVehicles = "%prefix% You may not use vehciles in this Island.";
    public String cantUseLeash = "%prefix% You may not use leads in this Island.";
    public String cantUseItemFrames = "%prefix% You may not use Item Frames in this Island.";
    public String cantUseAnvil = "%prrefix% &7You may not use anvils in this Island.";
    public String cantUseBeacon = "%prefix% &7You may not use beacons in this Island.";
    public String cantUseRedstone = "%prefix% &7Some redstone components are disabled in this Island.";
    public String cantPotion = "%prefix% &7You may not throw potions in this Island.";
    public String cantFish = "%prefix% &7You may not fish in this Island.";
    public String cantChickenEgg = "%prefix% &7You may not throw Chicken Eggs in this Island.";
    ...
    public String cantUseFlags = "%prefix% &7You may not manage flags in this Island.";
    public String cantSetHome = "%prefix% &7You may not set home in this Island";
    ...
    public String islandCreated = "&b&lWelcome";
